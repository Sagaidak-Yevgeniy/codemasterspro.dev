  ...
  const translations = {
    ru: {
      ...
      curriculumModules: [
        ...
        {
          module: 'Модуль 3: Продвинутый JavaScript',
          topics: ['ES6+ возможности', 'Асинхронное программирование', 'Работа с API', 'Обработка данных']
        },
        {
          module: 'Модуль 4: Современные технологии',
          topics: ['React.js', 'Next.js', 'TypeScript', 'Компонентный подход', 'State management', 'Роутинг']
        },
        {
          module: 'Модуль 5: Backend разработка',
          topics: ['Node.js', 'Express.js', 'REST API', 'Работа с базами данных']
        },
        {
    ...
    kk: {
      ...
      curriculumModules: [
        ...
        },
        {
          ...
          topics: ['HTML және CSS', 'Интерактивті элементтер', 'Формалар және валидация', 'Адаптивті дизайн']
        },
        {
          module: 'Модуль 3: Жоғары JavaScript',
          topics: ['ES6+ мүмкіндіктері', 'Асинхронды бағдарламалау', 'API жұмысы', 'Деректерді өңдеу']
        },
        {
          module: 'Модуль 4: Заманауи технологиялар',
          topics: ['React.js', 'Next.js', 'TypeScript', 'Компоненттік тәсіл', 'State management', 'Роутинг']
        },
        {
          module: 'Модуль 5: Backend даму',
          topics: ['Node.js', 'Express.js', 'REST API', 'Дерекқорлармен жұмыс']
        },
        {
